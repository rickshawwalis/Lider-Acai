//CODIGO DA PAGINA INDEX PRODUTOS    
    ...
    if (produtoSelecionado) {
        ...
        if (produtoSelecionado.id === "copo300") {
            ...
            window.location.href = "../Lider-Acai/copo500/pagina-Acompanhamento.html.html"; // Insira o caminho da página desejada
        }
            ...
            window.location.href = "../Lider-Acai/Lider-Acai/pote360/pagina-Acompanhamento.html"; // Insira o caminho da página desejada
        }
